  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container-fluid nav-top">
        ...
        <form class="form-inline input-group col-sm-2">
          <input class="form-control nav-search" type="search" aria-label="Search" placeholder="Search...">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="index.html#get-exercise">Get Exercise</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="index.html#get-involved">Get Involved</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="index.html#get-educated">Get Educated</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="index.html#about-us">About Us</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Exercise Counseling Location Section -->
    <section class="ex-counseling-locations">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Exercise Counseling Locations</h2>
            <h3 class="text-muted fitness-subheading">Choose the location that works best for your exercise counseling session.</h3
          ></div>
        </div>
<div class="row locations-row">
				  ...
				  </div></div><div class="row locations-row">  </div>
    </section><div class="portfolio-modal modal fade" id="UCSFModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    </div><div class="portfolio-modal modal fade" id="MGHModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
    ...
    </div><div class="portfolio-modal modal fade" id="StanfModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
    ...
    </div><div class="portfolio-modal modal fade" id="StanfSBModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
    ...
    </div><div class="portfolio-modal modal fade" id="CMCCModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
    ...
    </div><div class="portfolio-modal modal fade" id="KaiserModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
            ...
            <div class="row">
              <div class="col-lg-10 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">Sessions include:</p>
                  <p class="text-muted"> Sessions are available at various locations by appointment only.<form class="needs-validation" action="../Generosa/IntakeLocationGen.php?K=s75327638OKKQOMT057482944sjsx3"
    ...
    </div><div class="portfolio-modal modal fade" id="ShantiModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
            ...
            <div class="row">
              <div class="col-lg-10 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="text-muted"> Sessions are available the second and fourth Friday of each month at The Shanti Project<br>730 Polk St #3, San Francisco, CA 94109<br>                     <a href="https://www.google.com/maps/place/Shanti+Project/@37.7838727,-122.4192114,15z/data=!4m2!3m1!1s0x0:0x317aa7c8c35ce366" target="_blank">Click here for map</a><form class="needs-validation" action="../Generosa/IntakeLocationGen.php?K=p94817746FEGG192687165uboccbbyvj7"
>>>>>>> 2f9413fed47b0699584da71f2c9ab97e5e262d7f
    ...
    </div><div class="portfolio-modal modal fade" id="SFWModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; Sunflower Wellness 2018</span>
          </div>
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              <li class="list-inline-item">
                <a href="https://www.facebook.com/SunflowerWellness" target="_blank">
                  <i class="fab fa-facebook-f"></i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="https://twitter.com/sunflowerwell" target="_blank">
                  <i class="fab fa-twitter"></i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="https://www.linkedin.com/company/sunflower-wellness?trk=top_nav_home" target="_blank">
          ...
          <div class="col-md-4">
            <ul class="list-inline quicklinks">
              <li class="list-inline-item">
                <a href="https://www.sunflowerwellness.org/sfw/about/privacy/" target="_blank">Privacy Policy</a>
              </li>
              <li class="list-inline-item">
                <a href="http://sunflowerwellness.org/secsfw/Terms.php" target="_blank">Terms of Use</a>
              </li>
              <li class="list-inline-item">
                <a href="https://www.sunflowerwellness.org/secsfw/LoginMain.php" target="_blank">Log In</a>
              </li>
            </ul>
          </div>
        </div>
